...
[assembly: ExportRenderer(typeof(EntryPadrao), typeof(EntryPadraoRenderer))]
namespace RentMobile.Droid
{
    public class EntryPadraoRenderer : EntryRenderer
    {
        public EntryPadraoRenderer(Context context) : base(context)
        {
